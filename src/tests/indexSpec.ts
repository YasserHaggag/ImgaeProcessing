...
describe('API Resize testsuite', () => {
   ...
   it('test the Resizeimage function with Valid data', async () => {
      const res = await request.get('/api/imageResize?name=fjord&width=10&height=5')
   ...
   it('test the Resizeimage function with string in hieght', async () => {
      const res = await request.get('/api/imageResize?name=fjord&width=50&height=ssssss')
   ...
   it('test the Resizeimage function with string in width', async () => {
      const res = await request.get('/api/imageResize?name=fjord&width=anytext&height=600')
      expect(res.status).toBe(400)
   ...
   it('test the Resizeimage function with wrong image name', async () => {
      const res = await request.get('/api/imageResize?name=ford&width=600&height=600')
